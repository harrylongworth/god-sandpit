...
/** @type {string} */
const CACHE_VERSION = '1763074777|1150978016';
/** @type {string} */
const CACHE_PREFIX = 'Sandpit-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Sandpit.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Sandpit.html","Sandpit.js","Sandpit.offline.html","Sandpit.icon.png","Sandpit.apple-touch-icon.png","Sandpit.audio.worklet.js","Sandpit.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Sandpit.wasm","Sandpit.pck"];
